...
public class AppiumIOsDriver extends AppiumBaseDriver{
	...
	public AppiumIOsDriver() throws Exception {
		...
		ios_configuration = PropertiesLoader.getPropertiesLoader().appium_ios_configuration;
	...
	private void setIOSAppCapabilities(DesiredCapabilities capabilities) throws Exception {
		...
		String strMobileIOSApp = FilePaths.getResourcePath("/config/appium/app/" + ios_configuration.getProperty("appium.ios.app"));
